...
class MobileNet(nn.Module):
    def __init__(self, num_classes=1000, multiplier=1.0, norm_layer=nn.BatchNorm2d, **kwargs):
        ...
        features = [_ConvBNReLU(3, input_channels, kernel_size=3, stride=2, padding=1, norm_layer=norm_layer)]
...
if __name__ == '__main__':
    ...
    model = MobileNet(classes=19).to(device)
